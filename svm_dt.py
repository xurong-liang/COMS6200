"""
This script conducts testing and evaluation of svm with linear, rbf and poly kernels and decision tree.
"""
...
if __name__ == "__main__":
    ...
    for method in ["minmax", "unnormalized", "zscore"]:
        for c_type in ['svm-linear', 'svm-poly', 'svm-rbf', "decision tree"]:
